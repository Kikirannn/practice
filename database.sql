...
('siswa1', 'tes', 'Ahmad Fauzi', 'siswa'),
('siswa2', 'tes', 'Siti Nurhaliza', 'siswa'),
('siswa3', 'tes', 'Budi Santoso', 'siswa'),
('admin1', 'tes', 'Ibu Ratna', 'admin'),
('admin2', 'tes', 'Pak Hendra', 'admin'),
('teknisi1', 'tes', 'Joko Widodo', 'teknisi'),
('teknisi2', 'tes', 'Andi Pratama', 'teknisi');
